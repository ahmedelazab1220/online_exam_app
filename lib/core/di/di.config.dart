...
import '../../features/auth/login/presentation/view_model/login_cubit/login_cubit.dart'
    as _i58;
import '../../features/auth/sign_up/presentation/view_model/signup_cubit/signup_cubit.dart'
    as _i289;
...
import '../utils/hive_storage_module.dart' as _i760;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.singleton<_i96.BlocObserverService>(() => _i96.BlocObserverService());
    ...
    await gh.factoryAsync<_i986.Box<_i231.LocalUser>>(
      () => hiveStorageModule.userBox,
      instanceName: 'userBox',
      preResolve: true,
    );
    gh.singleton<_i179.UsersLocalDatabase>(() => _i179.UsersLocalDatabase(
        gh<_i986.Box<_i231.LocalUser>>(instanceName: 'userBox')));
    gh.factory<_i488.AuthLocalDatasource>(() => _i938.AuthLocalDatasourceImpl(
          gh<_i558.FlutterSecureStorage>(),
          gh<_i179.UsersLocalDatabase>(),
        ));
...
class _$HiveStorageModule extends _i760.HiveStorageModule {}
